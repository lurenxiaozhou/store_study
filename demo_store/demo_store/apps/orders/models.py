...
from demo_store.utils.models import BaseModel
...
class OrderInfo(BaseModel):
    ...
    status = models.SmallIntegerField(choices=ORDER_STATUS_CHOIVES,default=1,verbose_name="订单状态")
