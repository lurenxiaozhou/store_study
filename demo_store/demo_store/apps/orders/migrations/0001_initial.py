# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2019-07-16 09:22
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0004_auto_20190708_1940'),
        ('goods', '0002_auto_20190710_1943'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(3, '待收货'), (5, '已完成'), (2, '待发货'), (1, '待支付'), (6, '已取消'), (4, '待评价')], default=1, verbose_name='订单状态')),
